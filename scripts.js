...
/*
 ...
 ga('create', 'UA-34016412-3', 'stepofweb.com');
 ga('send', 'pageview');
...
if (jQuery("#slider").length > 0) {
    jQuery("#slider").superslides({
        ...
        play: 4000, // false to disable autoplay -OR- miliseconds (eg.: 1000 = 1s)
        animation_speed: 800, // animation transition
...
jQuery("#contact_submit").bind("click", function(e) {
    ...
    if (contact_email == '' || !email_reg.test(contact_email)) {
        jQuery("#contact_email").addClass('err');
        var _err = true;
    }
    ...
    $("#lodingContainer").removeClass('hide');
    $("#contact_submit").addClass('hide');
    ...
    $.ajax({
        ...
        error: function(XMLHttpRequest, textStatus, errorThrown) {
            ...
            jQuery("#_error_").removeClass('hide');
            $("#lodingContainer").addClass('hide');
            $("#contact_submit").removeClass('hide');
...
jQuery('#upcoming-events .quick-hover').hover(function() {
